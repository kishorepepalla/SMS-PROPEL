		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="changesubject1.php"> subjects</a>
                </div>
            ...
            <div>
                ...
                <a href="dashboard1.php" class="btn btn-success" role="button">back</a>
...
$(document).ready(function(){  
    ...
    $(document).on('blur', '.sub6', function(){  
     ...
     $(document).on('blur', '.sub7', function(){  
        var id = $(this).data("id7");  
        var sub6 = $(this).text();  
        edit_data(id,sub6, "sub6");  
    });
      $(document).on('blur', '.sub8', function(){  
        var id = $(this).data("id7");  
        var sub6 = $(this).text();  
        edit_data(id,sub6, "sub6");  
    });
