...
{
$sql="SELECT `phone_no`,`message` FROM student_ext";
...
window.location.href='sendmessage1.php';
</script>";      
...
if (mysqli_query($connect, $sql)) {
    echo "<script>alert('data deleted successfully');
     ...
     echo "<script>alert('data was not deleted');
       window.location.href='sendmessage1.php';</script>";
       ...
       <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="sendmessage1.php">send message</a>
                </div>
            ...
            <div>
                ...
                <a href="updatemessage1.php" class="btn btn-warning" role="button">back</a>
                 <a href="dashboard1.php" class="btn btn-primary" role="button">START PAGE</a>
